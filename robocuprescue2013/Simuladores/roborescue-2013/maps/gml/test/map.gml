  ...
  <rcr:buildinglist>
    ...
    <rcr:building gml:id="251">
      <gml:Face rcr:floors="1" rcr:buildingcode="0" rcr:importance="1">
        ...
        <gml:directedEdge orientation="+" xlink:href="#122" rcr:neighbour="971"/>
        <gml:directedEdge orientation="+" xlink:href="#205" rcr:neighbour="968"/>
        <gml:directedEdge orientation="+" xlink:href="#221" rcr:neighbour="969"/>
    ...
    <rcr:building gml:id="254">
      <gml:Face rcr:floors="1" rcr:buildingcode="0" rcr:importance="1">
        ...
        <gml:directedEdge orientation="+" xlink:href="#223" rcr:neighbour="975"/>
        <gml:directedEdge orientation="+" xlink:href="#228" rcr:neighbour="976"/>
